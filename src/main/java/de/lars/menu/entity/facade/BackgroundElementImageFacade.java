 ...
 */
@Stateless
public class BackgroundElementImageFacade extends AbstractFacade<BackgroundElementImage> {
    ...
    public BackgroundElementImageFacade() {
        super(BackgroundElementImage.class);
    }
